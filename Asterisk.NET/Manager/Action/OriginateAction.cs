...
namespace AsterNET.Manager.Action
{
    ...
    public class OriginateAction : ManagerActionEvent, IActionVariable
    {
        ...
        #endregion ActionCompleteEventClass
        ...
        #endregion SetVariables(IDictionary vars)
        ...
        #endregion GetVariable(string name, string val)
        ...
        #endregion SetVariable(string name, string val)
    }
}