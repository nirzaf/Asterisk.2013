...
namespace AsterNET.FastAGI
{
    ...
    public abstract class AGIScript
    {
        ...
        #endregion PlayMusicOnHold(string musicOnHoldClass)
        ...
        #endregion GetData(string file, int timeout)
        ...
        #endregion GetData(string file, int timeout, int maxDigits)
        ...
        #endregion GetOption(string file, string escapeDigits)
        ...
        #endregion GetOption(string file, string escapeDigits, int timeout)
        ...
        #endregion Exec(string application)
        ...
        #endregion Exec(string application, string options)
        ...
        #endregion SetPriority(int priority)
        ...
        #endregion SetPriority(string label priority)
        ...
        #endregion StreamFile(string file)
        ...
        #endregion StreamFile(string file, string escapeDigits)
        ...
        #endregion SayDigits(string digits)
        ...
        #endregion SayDigits(string digits, string escapeDigits)
        ...
        #endregion SayNumber(string number)
        ...
        #endregion SayNumber(string number, string escapeDigits)
        ...
        #endregion SayPhonetic(string text)
        ...
        #endregion SayPhonetic(string text, string escapeDigits)
        ...
        #endregion SayAlpha(string text)
        ...
        #endregion SayAlpha(string text, string escapeDigits)
        ...
        #endregion SayTime(long time, string escapeDigits)
        ...
        #endregion GetVariable(string name)
        ...
        #endregion SetVariable(string name, string value_Renamed)
        ...
        #endregion WaitForDigit(int timeout)
        ...
        #endregion GetFullVariable(string name)
        ...
        #endregion GetFullVariable(string name, string channel)
        ...
        #endregion DatabaseGet(string family, string key)
        ...
        #endregion DatabasePut(string family, string key, string value)
        ...
        #endregion DatabaseDel(string family, string key)
        ...
        #endregion DatabaseDelTree(String family)
        ...
        #endregion DatabaseDelTree(string family, string keytree)
        ...
        #endregion Verbose(string message, int level)
        ...
        #endregion SendCommand(Command.AGICommand command)
        ...
        #endregion Service(AGIRequest param1, AGIChannel param2);
    }
}