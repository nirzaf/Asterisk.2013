...
namespace AsterNET.FastAGI
{
    ...
    public class AGIRequest
    {
        ...
        #endregion Constructor - AGIRequest(ICollection environment)
        ...
        #endregion Asterisk 1.0 CallerID and CallerIdName
        ...
        #endregion Parameter(string name)
        ...
        #endregion ParameterValues(string name)
        ...
        #endregion buildMap(ICollection lines)
        ...
        #endregion parseParameters(string s)
    }
}