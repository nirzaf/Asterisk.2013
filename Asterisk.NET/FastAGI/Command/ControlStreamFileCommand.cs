...
namespace AsterNET.FastAGI.Command
{
    ...
    public class ControlStreamFileCommand : AGICommand
    {
        ...
        #endregion ControlStreamFileCommand(string file)
        ...
        #endregion ControlStreamFileCommand(string file, string escapeDigits)
        ...
        #endregion ControlStreamFileCommand(string file, string escapeDigits, int offset)
        ...
        #endregion ControlStreamFileCommand(string file, string escapeDigits, int offset, string forwardDigit, string rewindDigit, string pauseDigit)
        ...
        #endregion ControlDigits(string forwardDigit, string rewindDigit)
        ...
        #endregion ControlDigits(string forwardDigit, string rewindDigit, string pauseDigit)
