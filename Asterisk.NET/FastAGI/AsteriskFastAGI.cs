...
namespace AsterNET.FastAGI
{
    public class AsteriskFastAGI
    {
        ...
        #endregion Constructor - AsteriskFastAGI()
        ...
        #endregion Constructor - AsteriskFastAGI(int port, int poolSize)
        ...
        #endregion Constructor - AsteriskFastAGI(string address, int port, int poolSize)
